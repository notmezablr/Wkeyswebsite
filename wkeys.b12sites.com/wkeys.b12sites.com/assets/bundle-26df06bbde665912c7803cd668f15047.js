! function(modules) {
    ...
    var cookieManager = {
        ...
        banner = {
            ...
            bannerOuterHeight: 0,
            checkCookie: function checkCookie() {
                return this.cookieExp <= 0 ? (cookieManager.erase("sb_banner_shown"), !1) : "true" === cookieManager.get("sb_banner_shown")
            },
            createCookie: function createCookie() {
            ...
            setEventHandlers: function setEventHandlers(persistOnRefresh) {
                $(this.bannerContainerSelector).find(".sb-banner__close").on("click", function() {
                    banner.hide(), persistOnRefresh || setTimeout(function() {
                        banner.remove()
                    }, 1e3)
            ...
            init: function init() {
                var persistOnRefresh = $(banner.bannerContainerSelector).find(".sb-banner").data("persist");
                !persistOnRefresh && this.checkCookie() || (this.hide(), $(this.bannerCloseButton).addClass("is-clickable"), banner.setEventHandlers(persistOnRefresh), $(window).resize(function() {
                    if (banner.outerHeight = $(banner.bannerContainerSelector).outerHeight(), !$(this.navigationSectionSelector).hasClass("option-nav-fixed") && $("body").hasClass("is-banner-out")) {
        ...
        arrowLeft = '<svg viewBox="0 0 14 26" xmlns="http://www.w3.org/2000/svg"><path d="M9.844 25.187c.805.934 2.274 1.086 3.28.338 1.007-.748 1.17-2.112.364-3.046L5.323 13l8.165-9.479c.806-.934.643-2.298-.364-3.046-1.006-.748-2.475-.596-3.28.338L.512 11.646a2.047 2.047 0 000 2.708l9.332 10.833z" fill="#FFF" fill-rule="evenodd"/></svg>',
        arrowRight = '<svg viewBox="0 0 14 26" xmlns="http://www.w3.org/2000/svg"><path d="M4.156 25.187c-.805.934-2.274 1.086-3.28.338-1.007-.748-1.17-2.112-.364-3.046L8.677 13 .512 3.521C-.294 2.587-.131 1.223.876.475 1.882-.273 3.35-.12 4.156.813l9.332 10.833a2.047 2.047 0 010 2.708L4.156 25.187z" fill="#FFF" fill-rule="evenodd"/></svg>',
